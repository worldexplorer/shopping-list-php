...
$msg_tag_shortcut = "<img src='img/shortcut.gif' width=7 height=7 style='border:0px solid #eeeeee; padding-bottom:2px' align=absmiddle hspace=4 vspace=2 />";
...
switch ($lang_current) {
	...
	case "fr":
		...
		$entity_list = array (
			...
			"game" => "Игры",
			"tour" => "Туры",
			"m2m_game_team" => "Команды в игре",
			"question" => "Вопросы",
			"m2m_team_question" => "Ответы команд",
		...
		$add_entity_msg_list = array (
			...
			"game" => "новую игру",
			"tour" => "новый тур",
			//"m2m_team_game" => "Команды в игре",
			"question" => "новый вопрос",
			"m2m_team_question" => "новый ответ команды",
		...
		$new_entity_ident_list = array (
			...
			"game" => "новая игра",
			"tour" => "новый тур",
			//"m2m_team_game" => "новая команда в игре",
			"question" => "новый вопрос",
			"m2m_team_question" => "новый ответ команды",
...
// common
			...
			"annotation-graycomment" => "подпись <a href=../mmenu.php?id=#PARENT_ID# target=_blank>на родителе</a> в квадратном блоке под шапкой",
			"hashkey" => "Ключ",
...
//			"content-edit" => "Описание<br><br>текст в<br>карточку товара,<br>текст новости ...",
			...
			//poll-edit.php
			"whatsapp_rendering" => "Как будет выглядеть в Whatsapp", 
...
// product
			...
			"product-brief-edit" => "Кратко<br><br>в список товаров<br>группы<br><br>",
...
// pgroup
			"ident" => "Название",
			"pgroup-brief" => "Текст перед<br>списком товаров",
			"divclass" => "Класс DIV",
			//"file1" => "Картинка в меню",
			//"file1-graycomment" => "только для корневых групп",

// currency
			"currency-ident" => "Валюта",
			"date_exchrate_rub" => "Дата курса",
			"exchrate_rub" => "Курс перевода в рубли",
			"exchrate_rub-edit" => "Курс перевода<br>в рубли",
			"exchrate_rub_multiplier" => "Множитель",
			"exchrate_rub_multiplied" => "Итог",	//Итоговый курс
			"exchrate_rub_multiplied-edit" => "Итоговый курс",
			"date_expiration" => "Истекает",
			"expiration_minutes" => "Мин",
			"expiration_minutes-edit" => "Хранить, мин",
			"expiration_minutes-graycomment" => ", при авт. обновлении: дата Истекает = СЕЙЧАС + СТОЛЬКО",
			
			"currency-date_updated" => "Обновление",
			//"src_href" => "<a href='#SRC_HREF#' target=_blank>src_href</a>",
...
// mozgoboi
			"team-brief" => "Краткоe<br>описание<br>команды",
			"team-content" => "Полное<br>описание<br>команды",
			"tour-brief" => "Комментарий",
			"tour-blitz" => "Блиц",
			"question-answer" => "Правильный ответ",
			"question-brief" => "Кратко",
...
//slspicy
			...
			"person-auth" => "Токен",
			"person-female" => "Жен",
			"person-unsubscribed" => "Отписался",
			"person-published" => "Активен",
			"person-published-graycomment" => "Отображается в отчётах, может зайти на сайт с текущим Токеном",
			"pollanswer" => "Вопросы",
			"pollanswer-multicb" => "Чекбоксовый",
			"poll-tooltip" => "Tooltip",
			"poll-comment_above" => "Верхний коммент",
			"poll-comment_below" => "Нижний коммент",
...
// icsheet
			"icsheet-id" => "Номер",
			"icsheet-ident" => "Чья заявка",
			"icsheet-content" => "Форма",
...
// shop
			...
			"shop-email" => "E-mail",
			"shop-hrefto" => "Ссылка",
			"shop-content" => "Адрес,<br>телефон,<br>как проехать<br>как пройти<br>часы работы",
...
// common
			...
			"annotation-graycomment" => "a label below menu item",
			"hashkey" => "Key",
			"recursive" => "Submenu",
...
// mtpl
			...
			"admtail-graycomment" => "text in this field is added to letter; you may use #HTTP_HOST# etc...; #CLIENT_SENTMSG# if empty",
			"sender" => "Sender",
			"rcptto" => "Recipient",
			...
			"sentmsg-graycomment" => "FrontEnd message after mail was sent successfully (javascript:alert)",
...
// sentlog
			"sentlog-content-list" => "Email Body",
			"sentlog-content-edit" => "Email<br>Body",
