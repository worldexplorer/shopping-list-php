...
$markers_hash = array (
	...
	"confirm" => "",
	"askme_clause" => urlencode("����������� �������� � ������������ ������������ ���� ��� ����������� ������������"),

	"submit_HTMLrow" => ($mode == "")
		? "<tr><td colspan=2><td align=left><input type='button' onclick='form_edit_submit_with_passwds_are_equal()' value='������������������'></td></tr>"
		: "<tr><td colspan=2><td align=left><input type='button' onclick='form_edit_submit_with_passwds_are_equal()' value='������������������ ��� ���'></td></tr>"
		,
);
//$cookie_debug = 1;
...
//$markers_hash["select_city"] = select_table_all("city", $markers_hash["city"], "ident", "", array(), "- �� ������� -", 0);
...
<tr>
	<td align=right>���� ������<br>����������� ��������,<br><a href="askme.php?subject=#ASKME_CLAUSE#">�������� ��� �� ����</a></td>
	<td></td>
	<td>#CONFIRM_IMG#</td>
</tr>
<tr> 
...
if ($mode == "update" && $errormsg == "") {
	...
	if (isset($person_row["id"])) {
		 $errormsg = "����� [" . $markers_hash["login"] . "] ��� �����; ���� ��� ��� - ���������� � <a href='askme.php?subject=" . urlencode("����� " . $markers_hash["login"] . " ��� �����") . "'>��������������</a>";
	}
}
...
jsv_addvalidation("JSV_TF_CHAR", "login", "�����");
jsv_addvalidation("JSV_TF_CHAR", "passwd", "������");
jsv_addvalidation("JSV_TF_CHAR", "passwd2", "������ ��� ���");
jsv_addvalidation("JSV_TF_EMAIL", "email", "��� Email");
jsv_addvalidation("JSV_TF_CHAR", "cname", "���� ���");
//jsv_addvalidation("JSV_TF_CHAR", "city", "� ����� ������ �� �����");
//jsv_addvalidation("JSV_PLAINDATE_FILLED", "date_birth", "���� ��������");
//jsv_addvalidation("JSV_TF_CHAR", "confirm", "��� �� ��������");
