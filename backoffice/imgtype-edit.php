...
//	"every3_merge_type" => array ("Метод наложения", "number", 0, "0=пропорционайльный ресайз; 1=tile"),
	...
	"first4_autoresize_qlty" => array ("Качество авторесайза3", "number", "80", "качество сохранения JPEG: 0&#8230;100"),
	"first4_autoresize_width" => array ("Ширина авторесайза3", "number", ""),
	"first4_autoresize_height" => array ("Высота авторесайза3", "number", ""),
...
//	"every4_merge_type" => array ("Метод наложения", "number", 0, "0=пропорционайльный ресайз; 1=tile"),
	...
	"msg_change" => array ("Надпись [изменить картинку]", "textfield", "картинку"),
